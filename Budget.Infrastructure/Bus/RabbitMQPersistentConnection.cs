...
namespace Budget.Infrastructure.Bus
{
    public class RabbitMQPersistentConnection : IPersistentConnection<IModel>
    {
        ...
        public RabbitMQPersistentConnection(BudgetConfiguration configuration, ILogger<RabbitMQPersistentConnection> logger)
        {
        ...
        private IConnectionFactory CreateFactory(BudgetConfiguration configuration)
        {
